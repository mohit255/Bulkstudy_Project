        ...
        <div id="edit_book_Modal" class="modal fade">
			...
			?>
                ...
                <form method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label>Ncrt Book PDF</label>
                        <input type="file" name="nb_pdf" id="nb_pdf" class="form-control" required />
                    </div>
                    <div class="form-group">
                        <label>Ncrt Book Image</label>
...
$(document).ready(function() {
	...
	$('.book_edit').click(function(){
		...
		$.ajax({ 
				...
				{
					//console.log(data);
					$('#edit_book_Modal').('show');
					$('#nb_name').val(data.nb_name);
					$('#nb_class').val(data.nb_class);
					$('#nb_subject').val(data.nb_subject);
					$('#nb_year').val(data.nb_year);
					$('#nb_pdf').val(data.nb_pdf);
					$('#nb_image').val(data.nb_image);
                }
               });
      });
