								...
								<table class="table table-bordered table-striped">
									...
									<tbody>
									  ...
									  <?php
										...
										{
											$querry="select * from sample_paper where sp_class=9";
										...
										else
										{
											...
											if($pselectedsubject != "")
											{
												$querry="select * from sample_paper where sp_class=9 AND sp_subject='$pselectedsubject'";
											}
											else
											{
												$querry="select * from sample_paper where sp_class=9";
