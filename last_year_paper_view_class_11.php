...
<?php */?><div class="courses_section courses-fullwidth">
			<div class="container">
              <h1>Class 11 last year paper</h1>
				<div class="row">
						...
						<div class="courses_right_inner">
                         ...
                         <div class="search_section">
				                ...
				                <select name="subject" id="guiest_id1">
				                  ...
				                  <?php
								  $ssub[]="";
                                $squerry="select * from class_11_last_year_paper";
                          ...
                          <?php    $ssub[]=$srow['paper_subject'];
							  ...
							  <div class="selectBox clearfix">
                                ...
                                <?php
								$yyear[]="";
								$yquerry="select * from class_11_last_year_paper";
								...
								<table class="table table-bordered table-striped">
									...
									<tbody>
									  ...
									  $querry="";
										if(!isset($_POST['lastyrppr_search']))
										{
											$querry="select * from class_11_last_year_paper";
