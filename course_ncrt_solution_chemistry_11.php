				...
				<div class="container">
					<div class="row">
							...
							<div class="courses">
								<table class="table table-bordered table-striped">
									...
									<tbody>
									  ...
									  <?php
											$querry="select * from solution_chemistry where chapter_subject = 'Chemistry' && chapter_class = '11' ORDER BY chapter_no ASC";
						...
						<div class="col-xs-12 col-sm-4 post_right pull-left">
                            ...
                            <?php
							$query="select * from ncrt_solution where book_subject = 'Chemistry' && book_class = '11'";
