				...
				<div class="container">
					<div class="row">
							...
							<div class="courses">
								<table class="table table-bordered table-striped">
									...
									<tbody>
									  ...
									  <?php
											$querry="select * from solution_social where chapter_subject = 'Social Science' && chapter_class = '10' ORDER BY chapter_no ASC";
											...
											<tr>
                                                ...
                                                <td>
													<ul>
														<li class='active'>
															<a href='books/solution_social_chapter_pdf/<?php echo $row['chapter_pdf']; ?>'>Download Link</a>
														</li>
													</ul>    
												</td>
											</tr>
						...
						<div class="col-xs-12 col-sm-4 post_right pull-left">
                            ...
                            <?php
							$query="select * from ncrt_solution where book_subject = 'Social Science' && book_class = '10'";
