				...
				<div class="container">
					<div class="row">
							...
							<div class="courses">
								<table class="table table-bordered table-striped">
									...
									<tbody>
									  ...
									  <?php
											$querry="select * from chapters_physics where chapter_subject = 'Physics' && chapter_class = 11 ORDER BY chapter_no ASC";
						...
						<div class="col-xs-12 col-sm-4 post_right pull-left">
                            ...
                            <?php
							$query="select * from ncrt_book where book_subject = 'Physics' && book_class = 11";
